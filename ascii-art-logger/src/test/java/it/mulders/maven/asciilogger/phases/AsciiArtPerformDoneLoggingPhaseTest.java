...
class AsciiArtPerformDoneLoggingPhaseTest {
    private final LogCaptor logCaptor = LogCaptor.forClass(AsciiArtPerformDoneLoggingPhase.class);
    private static final String BANNER = "Banner";

    private AsciiArtGenerator asciiArtGenerator = mock(AsciiArtGenerator.class);

    private AsciiArtPerformDoneLoggingPhase phase = new AsciiArtPerformDoneLoggingPhase();
